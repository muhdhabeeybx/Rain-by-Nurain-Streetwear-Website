...
import { useAdmin, AdminPromotion } from '../../contexts/AdminContextFixed';
...
export function PromotionModal({ isOpen, onClose, promotion, mode }: PromotionModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-xl m-0 md:m-8">
        <DialogHeader>
          <DialogTitle>
          ...
          <DialogDescription>
            {mode === 'add' 
              ? 'Create a new promotional code to offer discounts to your customers.'
              : 'Update the promotion details. Changes will take effect immediately.'}
          </DialogDescription>
        </DialogHeader>
