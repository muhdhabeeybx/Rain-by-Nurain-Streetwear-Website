...
import { Heart, Globe, Users, Zap, Sparkles } from 'lucide-react'; // ✅ Added Sparkles import
...
const features = [
  {
    ...
    description:
      'Every piece goes through hands that care, eyes that see detail, and minds that dream global.',
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    title: 'Built to Last',
    description:
      'Quality that ages gracefully — because real style doesn’t expire.',
  },
];
        ...
        <div className="bg-white p-8 md:p-16 lg:p-20 shadow-sm border border-gray-100">
          ...
          >
            ...
            <p className="font-body text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              ...
              understand that “home” isn’t just a place; it’s carried within. Every stitch is a
              salute to those who left, who grind, who build, and who return — bringing light,
              value, and vision.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="font-body text-lg font-semibold mb-4 tracking-tight">
                  {feature.title}
                </h3>
