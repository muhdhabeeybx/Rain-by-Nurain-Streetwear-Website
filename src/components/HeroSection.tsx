...
import heroImage from '../assets/rbnhero.jpg'; 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto hero-content mobile-keep-center">
        ...
        >
          <h1 className="font-heading text-[56px] md:text-6xl lg:text-7xl mb-8 leading-none tracking-tight">
            For the Hustlers & Dreamers
          </h1>
      ...
      >
        <div className="flex flex-col items-center">
          <p className="text-xs text-center uppercase tracking-wider mb-2 font-body">Scroll. Don’t just wear it — live it.</p>
